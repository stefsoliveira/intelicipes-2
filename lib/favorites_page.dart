...
class FavoriteRecipes extends StatefulWidget {
  ...
  const FavoriteRecipes({Key key, this.items}) : super(key: key);
  @override
  FavoritesRecipesPage createState() {
    return FavoritesRecipesPage();
  }
}
class FavoritesRecipesPage extends State<FavoriteRecipes>{
